...
class AboutMessagePassing < Neo::Koan
  ...
  def test_send_with_underscores_will_also_send_messages
    ...
    #
    # __send__ exists as a failsafe because classes may define their own #send method which works differently.
  end
  ...
  def test_calling_method_missing_causes_the_no_method_error
    ...
    #
    # Calling #method_missing on an object of that class would work as the redefined method dictates.
    # Calling a missing method on an object of that class would also invoke the redefined #method_missing.
    #
    # NOTE:
    #
