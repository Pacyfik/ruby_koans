...
class AboutRegularExpressions < Neo::Koan
  ...
  def test_asterisk_means_zero_or_more
    ...
    #
    # If there was something before of after it that doesn't match, e.g. "z"[/az*/].
  end
  ...
  # Why?
  #
  # They won't stop at the first matching pattern, they will scan the string further to look if the match can be "expanded".
  ...
  #
  # Character class matches one out of a set of characters.
  # Alternations allow longer strings.
