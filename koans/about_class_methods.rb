...
class AboutClassMethods < Neo::Koan
  ...
  #
  # The first option seems a bit more readable, although the second one works a bit differently.
  # It enables us to define a protected/private method, e.g.:
  # class << self
  #   private
  #   def private_method
  #     ...
  ...
  # end
  #
  # or open the metaclass of an object and add a class method to the object's class:
  # foo = Bar.new
  # class << foo
  #   def a_method
  #     ...
